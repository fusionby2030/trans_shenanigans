...
peaks, _ = find_peaks(max_alpha, height=simulation_state.pressure_grad_threshold-0.5) # simulation_state.pressure_grad_threshold-0.5
...
tstart_idx = peaks[-4] # N//2 # peaks[3]
tend_idx   = peaks[-3] -1 # N//2 + N//4 # peaks[5] # + 5
